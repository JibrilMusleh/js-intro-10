...
console.log(Number(n1) + Number(n2)); // 10.3
console.log(parseInt(n1) + parseInt(n2)); // 10.
console.log(parseFloat(n1) + parseFloat(n2));// '10.3'
...
console.log(Number.isInteger(754890272098752)); // true
console.log(Number.isSafeInteger(754890272098752999999)); // false
